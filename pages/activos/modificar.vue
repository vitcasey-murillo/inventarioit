...
async function cargarDataActivo() {
  ...
  modificarActivo.value.asignado = modificarActivo.value.asignado.replace(
...
async function ActualizarActivo(e) {
  ...
  const { error } = await client
    .from("activo")
    .update(modificarActivo.value)
    .match({ id: modificarActivo.value.id });
  if (error == null) {
    setTimeout(async () => {
...
async function revisarCampos() {
  desactivarCampos.value = arrBloquearCamposPara.includes(
    modificarActivo.value.tipo
  );
  if (desactivarCampos.value) {
    modificarActivo.value.discoDuro = "";
    modificarActivo.value.ram = "";
    modificarActivo.value.procesador = "";
  }
  console.log("ejecutado revisarCampos");
}

watch(()=> modificarActivo.value, () => {
...
<template>
  ...
  />
  <ModalConfirm
    :titulo="controlConfirm.titulo"
    :mensaje="controlConfirm.mensaje"
    :accion="controlConfirm.accion"
    v-if="controlConfirm.visulizar"
  />
        ...
        <fieldset>
          ...
          <label for="" class="col-10">
            ...
            <input
              ...
              name="modelo"
              class="form-control"
              v-model="modificarActivo.modelo"
          ...
          <label for="" class="col-10">
            ...
            <input
              ...
              name="serial"
              class="form-control"
              v-model="modificarActivo.serial"
              placeholder="S/N "
            />
          </label>
        </fieldset>
        ...
        <fieldset>
          <label for="" class="col-10">
            ...
            <select
              ...
              id=""
              class="form-control"
              v-model="modificarActivo.tipo"
			  @change="revisarCampos"
              required
            >
          ...
          <label for="" class="col-10">
            ...
            <input
              ...
              name="discoDuro"
              class="form-control"
              v-model="modificarActivo.discoDuro"
          ...
          <label for="" class="col-10">
            ...
            <input
              ...
              name="procesador"
              class="form-control"
              v-model="modificarActivo.procesador"
              placeholder="i5 8va"
              :disabled="desactivarCampos"
            />
          </label>
        ...
        <fieldset>
          <label for="" class="col-11">
            ...
            <select
              ...
              id=""
              class="form-control"
              v-model="modificarActivo.ubicacion"
              required
            >
          ...
          <label for="" class="col-11">
            ...
            <select
              ...
              id=""
              class="form-control"
              v-model="modificarActivo.estado"
              required
            >
          ...
          <label for="" class="col-11">
            ...
            <div style="display: flex; justify-content: center">
              <input
                ...
                name="asignado"
                class="form-control"
                v-model="modificarActivo.asignado"
